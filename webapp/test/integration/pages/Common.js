sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/in/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.in.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/in/localService/mockserver"], function (mockserver) {
